 ...
 * @author Chris.Liao
 */
public class SpringRegXDataSource extends SpringRegDataSource implements XADataSource {
    private XADataSource delegate;

    public SpringRegXDataSource(String dsId, XADataSource delegate, boolean traceSQL, boolean jndiDs) {
