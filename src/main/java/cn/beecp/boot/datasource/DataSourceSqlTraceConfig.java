 ...
 * @author Chris.Liao
 */
public class DataSourceSqlTraceConfig {
    ...
    private DataSourceSqlTraceAlert sqlExecAlertAction;
    ...
    public DataSourceSqlTraceAlert getSqlExecAlertAction() {
        return sqlExecAlertAction;
    }

    public void setSqlExecAlertAction(DataSourceSqlTraceAlert sqlExecAlertAction) {
